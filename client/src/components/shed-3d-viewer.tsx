    ...
    <div className="bg-white rounded-lg border-2 border-neutral-200 p-4 space-y-6">
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="border border-neutral-300 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-neutral-800 mb-3 text-center">PLAN VIEW</h4>
        ...
        {/* Front Elevation */}
        <div className="border border-neutral-300 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-neutral-800 mb-3 text-center">FRONT ELEVATION</h4>
          <svg viewBox="0 0 200 140" className="w-full h-32">
            {/* Foundation */}
            <rect 
              x={100 - (config.length * 6)} 
        ...
        {/* Side Elevation */}
        <div className="border border-neutral-300 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-neutral-800 mb-3 text-center">SIDE ELEVATION</h4>
          <svg viewBox="0 0 200 140" className="w-full h-32">
            {/* Foundation */}
            <rect 
        ...
        {/* Cross Section */}
        <div className="border border-neutral-300 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-neutral-800 mb-3 text-center">CROSS SECTION</h4>
          <svg viewBox="0 0 200 140" className="w-full h-32">
            {/* Foundation slab */}
            <rect 
              x={100 - (config.width * 6)} 
