...
export class DatabaseStorage implements IStorage {
  ...
  private async seedTemplates() {
    try {
      ...
      // Pre-populate with common shed templates featuring different roof styles
      const templates = [
        {
          name: "8x8 Basic Gable",
          length: 8,
          width: 8,
          height: 8,
        ...
        {
          name: "10x12 Barn Style",
          length: 12,
          width: 10,
          height: 9,
          roofType: "gambrel" as const,
          foundationType: "concrete-slab" as const,
          lumberGrade: "pressure-treated" as const,
          joistSpacing: 16,
          studSize: "2x4" as const,
        ...
        {
          name: "8x10 Modern Shed",
          length: 10,
          width: 8,
          height: 9,
          roofType: "shed" as const,
          foundationType: "concrete-slab" as const,
          lumberGrade: "pressure-treated" as const,
          joistSpacing: 16,
          studSize: "2x4" as const,
          ...
          doorCount: 1,
          windowCount: 2,
          sidingType: "metal" as const,
          roofingType: "metal" as const,
          isTemplate: true,
          templateCategory: "workshop",
        },
        {
          name: "12x16 Hip Roof Garage",
          length: 16,
          width: 12,
          height: 10,
        ...
        {
          name: "6x12 Lean-to Storage",
          length: 12,
          width: 6,
          height: 8,
          roofType: "lean-to" as const,
          foundationType: "gravel-pad" as const,
          lumberGrade: "pressure-treated" as const,
          joistSpacing: 16,
          studSize: "2x4" as const,
          wallHeight: 8,
        ...
        {
          name: "10x14 Colonial Saltbox",
          length: 14,
          width: 10,
          height: 9,
          roofType: "saltbox" as const,
          foundationType: "concrete-slab" as const,
          lumberGrade: "douglas-fir" as const,
          joistSpacing: 16,
          studSize: "2x4" as const,
          wallHeight: 8,
          doorCount: 1,
